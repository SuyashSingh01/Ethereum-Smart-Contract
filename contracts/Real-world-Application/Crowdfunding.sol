...
contract CrowdFunding{
 ...
 if(contributors[msg.sender]==0){ //if senders addr is not already a contributor
 ...
 address payable user=payable(msg.sender); //convert senders' addr into a payable
 ...
 numRequests++; // to keep the track of the total no of requests made by manager
